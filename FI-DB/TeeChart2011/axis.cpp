...
CChartAxisPen CAxis::GetAxisPen()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x4, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CChartAxisPen(pDispatch);
}
...
CAxisGridPen CAxis::GetGrid()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xd2, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CAxisGridPen(pDispatch);
}

BOOL CAxis::GetMaximumRound()
{
	BOOL result;
...
void CAxis::SetMaximumRound(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CAxis::SetMinimumRound(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CAxis::SetUsePartnerAxis(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
VARIANT CAxis::GetPartnerAxis()
{
	VARIANT result;
	InvokeHelper(0xd6, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
	return result;
}

void CAxis::SetPartnerAxis(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
