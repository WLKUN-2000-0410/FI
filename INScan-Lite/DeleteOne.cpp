...
IMPLEMENT_DYNAMIC(CDeleteOne, CDialog)

CDeleteOne::CDeleteOne(CWnd* pParent /*=NULL*/)
	: CDialog(CDeleteOne::IDD, pParent)
{

}

CDeleteOne::~CDeleteOne()
{
}

void CDeleteOne::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDeleteOne, CDialog)
	ON_BN_CLICKED(IDOK_SET, &CDeleteOne::OnBnClickedSet)
	ON_WM_PAINT()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDOK_SET, &CDeleteOne::OnBnClickedSet)
	ON_CBN_SELCHANGE(IDC_COMBO1, &CDeleteOne::OnCbnSelchangeCombo1)
END_MESSAGE_MAP()


// CDeleteOne 消息处理程序

HBRUSH CDeleteOne::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
BOOL CDeleteOne::PreTranslateMessage(MSG* pMsg)
{
...
void CDeleteOne::OnBnClickedSet()
{
	UpdateData(TRUE);
	CINScanLiteDlg * pDlg=(CINScanLiteDlg*)AfxGetApp()->GetMainWnd();
...
void CDeleteOne::UpdateLanguage()
{
	CINScanLiteDlg * pDlg=(CINScanLiteDlg*)AfxGetApp()->GetMainWnd();
...
void CDeleteOne::OnCbnSelchangeCombo1()
{
