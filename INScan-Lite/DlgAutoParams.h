...
class CDlgAutoParams : public CDialogEx
{
	DECLARE_DYNAMIC(CDlgAutoParams)

public:
	CDlgAutoParams(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CDlgAutoParams();

// 对话框数据
	enum { IDD = IDD_DLG_AUTOPARAMS };
...
private:
	...
	map<int, CRoundButton*> m_mapGroupBtn;
