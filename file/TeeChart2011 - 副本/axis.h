#if !defined(AFX_AXIS_H__B27CA77D_545B_4063_8FDF_19B7600AA7E8__INCLUDED_)
#define AFX_AXIS_H__B27CA77D_545B_4063_8FDF_19B7600AA7E8__INCLUDED_
...
public:
	...
	BOOL GetUsePartnerAxis();
	void SetUsePartnerAxis(BOOL bNewValue);
	VARIANT GetPartnerAxis();
	void SetPartnerAxis(const VARIANT& newValue);
	BOOL GetHorizontal();
	void SetHorizontal(BOOL bNewValue);
	CCustomAxes GetSubAxes();
	CTeeShape GetShape();
};
...
#endif // !defined(AFX_AXIS_H__B27CA77D_545B_4063_8FDF_19B7600AA7E8__INCLUDED_)
