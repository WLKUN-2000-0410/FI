...
void CBackImage::SetBottom(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CBackImage::SetRight(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CBackImage::GetDrawQuality()
{
	long result;
...
void CBackImage::SetDrawQuality(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
