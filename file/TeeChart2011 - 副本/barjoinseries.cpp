...
long CBarJoinSeries::GetRoundSize()
{
	long result;
...
void CBarJoinSeries::SetRoundSize(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CBarJoinSeries::GetMarksOnBar()
{
	BOOL result;
...
void CBarJoinSeries::SetMarksOnBar(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CBarJoinSeries::GetMarksLocation()
{
	long result;
...
void CBarJoinSeries::SetMarksLocation(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CBarJoinSeries::GetBarRound()
{
	long result;
...
void CBarJoinSeries::SetBarRound(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeEmboss CBarJoinSeries::GetEmboss()
{
	LPDISPATCH pDispatch;
...
BOOL CBarJoinSeries::GetGradientRelative()
{
	BOOL result;
...
void CBarJoinSeries::SetGradientRelative(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CTeeRect CBarJoinSeries::CalcBarBounds(long ValueIndex)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_I4;
