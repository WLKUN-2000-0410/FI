...
long CBarSeries::GetDepthPercent()
{
	long result;
...
void CBarSeries::SetDepthPercent(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeShadow CBarSeries::GetShadow()
{
	LPDISPATCH pDispatch;
...
long CBarSeries::GetTransparency()
{
	long result;
...
void CBarSeries::SetTransparency(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CBarSeries::SetBevelSize(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CBarSeries::SetDarkPen(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CBarSeries::SetRoundSize(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CBarSeries::SetMarksOnBar(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CBarSeries::GetMarksLocation()
{
	long result;
...
void CBarSeries::SetMarksLocation(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CBarSeries::SetBarRound(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeEmboss CBarSeries::GetEmboss()
{
	LPDISPATCH pDispatch;
...
BOOL CBarSeries::GetGradientRelative()
{
	BOOL result;
...
void CBarSeries::SetGradientRelative(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CTeeRect CBarSeries::CalcBarBounds(long ValueIndex)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_I4;
