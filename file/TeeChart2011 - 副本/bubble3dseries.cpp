...
void CBubble3DSeries::AddArrayXYZColor(const VARIANT& XArray, const VARIANT& YArray, const VARIANT& ZArray, const VARIANT& Colors)
{
	static BYTE parms[] =
...
long CBubble3DSeries::GetLineTransparency()
{
	long result;
...
void CBubble3DSeries::SetLineTransparency(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
