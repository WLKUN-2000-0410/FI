...
double CClockSeries::GetCustomXRadius()
{
	double result;
...
void CClockSeries::SetCustomXRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CClockSeries::GetCustomYRadius()
{
	double result;
...
void CClockSeries::SetCustomYRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
CTeeShadow CClockSeries::GetShadow()
{
	LPDISPATCH pDispatch;
...
CBrush1 CClockSeries::GetCircleBrush()
{
	LPDISPATCH pDispatch;
...
BOOL CClockSeries::GetColorEachLine()
{
	BOOL result;
...
void CClockSeries::SetColorEachLine(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CClockSeries::GetPointerBehind()
{
	BOOL result;
...
void CClockSeries::SetPointerBehind(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CClockSeries::GetDrawStyle()
{
	long result;
...
void CClockSeries::SetDrawStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CClockSeries::GetTreatNulls()
{
	long result;
...
void CClockSeries::SetTreatNulls(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CClockSeries::GetLabelsMargin()
{
	long result;
...
void CClockSeries::SetLabelsMargin(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CPolarLabels CClockSeries::GetAngleLabels()
{
	LPDISPATCH pDispatch;
...
void CClockSeries::SetStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CClockSeries::SetTime(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
CClockHand CClockSeries::GetHours()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x194, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CClockHand(pDispatch);
}

CClockHand CClockSeries::GetMinutes()
{
	LPDISPATCH pDispatch;
...
CClockHand CClockSeries::GetSeconds()
{
	LPDISPATCH pDispatch;
...
BOOL CClockSeries::GetCustomTime()
{
	BOOL result;
...
void CClockSeries::SetCustomTime(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CPointer CClockSeries::GetCenter()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x198, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CPointer(pDispatch);
}
