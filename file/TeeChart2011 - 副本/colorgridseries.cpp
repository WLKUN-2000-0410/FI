...
void CColorGridSeries::AddArrayXYZColor(const VARIANT& XArray, const VARIANT& YArray, const VARIANT& ZArray, const VARIANT& Colors)
{
	static BYTE parms[] =
...
long CColorGridSeries::GetLegendEvery()
{
	long result;
...
void CColorGridSeries::SetLegendEvery(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CColorGridSeries::CountLegendItems()
{
	long result;
...
void CColorGridSeries::LoadPaletteFromFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CColorGridSeries::SavePaletteToFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CColorGridSeries::ReCreateValues()
{
