...
void CContourSeries::AddArrayGrid(long NumX, long NumZ, const VARIANT& XZArray)
{
	static BYTE parms[] =
...
long CContourSeries::CalcZPos(long ValueIndex)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
void CContourSeries::AddArrayXYZColor(const VARIANT& XArray, const VARIANT& YArray, const VARIANT& ZArray, const VARIANT& Colors)
{
	static BYTE parms[] =
...
BOOL CContourSeries::GetUsePaletteMin()
{
	BOOL result;
...
void CContourSeries::SetUsePaletteMin(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
double CContourSeries::GetPaletteMin()
{
	double result;
...
void CContourSeries::SetPaletteMin(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CContourSeries::GetPaletteStep()
{
	double result;
...
void CContourSeries::SetPaletteStep(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
void CContourSeries::InvertPalette()
{
	InvokeHelper(0x130, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void CContourSeries::AddCustomPalette(const VARIANT& colorArray)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
long CContourSeries::GetLegendEvery()
{
	long result;
...
void CContourSeries::SetLegendEvery(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CContourSeries::CountLegendItems()
{
	long result;
...
void CContourSeries::LoadPaletteFromFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CContourSeries::SavePaletteToFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CContourSeries::SmoothGrid3D()
{
	InvokeHelper(0x191, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

BOOL CContourSeries::GetReuseGridIndex()
{
	BOOL result;
...
void CContourSeries::SetReuseGridIndex(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CContourSeries::FillGridIndex(long StartIndex)
{
	static BYTE parms[] =
		VTS_I4;
...
void CContourSeries::ReCreateValues()
{
...
CSmoothPoints CContourSeries::GetSmoothing()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x1f5, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CSmoothPoints(pDispatch);
}

CContourMarks CContourSeries::GetContourMarks()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x1f6, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CContourMarks(pDispatch);
}

CChartHiddenPen CContourSeries::GetFrame()
{
	LPDISPATCH pDispatch;
...
CPointer CContourSeries::GetPointer()
{
	LPDISPATCH pDispatch;
...
long CContourSeries::GetTransparency()
{
	long result;
...
void CContourSeries::SetTransparency(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CContourSeries::GetLegendLines()
{
	BOOL result;
...
void CContourSeries::SetLegendLines(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
unsigned long CContourSeries::GetLinesColor()
{
	unsigned long result;
...
void CContourSeries::SetLinesColor(unsigned long newValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CContourSeries::SetFilled(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
