...
double CDonutSeries::GetCustomXRadius()
{
	double result;
...
void CDonutSeries::SetCustomXRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CDonutSeries::GetCustomYRadius()
{
	double result;
...
void CDonutSeries::SetCustomYRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
CBrush1 CDonutSeries::GetCircleBrush()
{
	LPDISPATCH pDispatch;
...
long CDonutSeries::GetEdgeStyle()
{
	long result;
...
void CDonutSeries::SetEdgeStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CDonutSeries::GetBevelPercent()
{
	long result;
...
void CDonutSeries::SetBevelPercent(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CDonutSeries::GetTransparency()
{
	long result;
...
void CDonutSeries::SetTransparency(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CPieAngle CDonutSeries::GetAngles(long Index)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_I4;
