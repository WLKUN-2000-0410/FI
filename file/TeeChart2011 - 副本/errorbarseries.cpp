...
CPen1 CErrorBarSeries::GetTickLines()
{
	LPDISPATCH pDispatch;
...
long CErrorBarSeries::GetDepthPercent()
{
	long result;
...
void CErrorBarSeries::SetDepthPercent(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeShadow CErrorBarSeries::GetShadow()
{
	LPDISPATCH pDispatch;
...
long CErrorBarSeries::GetTransparency()
{
	long result;
...
void CErrorBarSeries::SetTransparency(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CErrorBarSeries::GetBevelSize()
{
	long result;
...
void CErrorBarSeries::SetBevelSize(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CErrorBarSeries::GetDarkPen()
{
	long result;
...
void CErrorBarSeries::SetDarkPen(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CErrorBarSeries::GetRoundSize()
{
	long result;
...
void CErrorBarSeries::SetRoundSize(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CErrorBarSeries::GetMarksOnBar()
{
	BOOL result;
...
void CErrorBarSeries::SetMarksOnBar(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CErrorBarSeries::GetMarksLocation()
{
	long result;
...
void CErrorBarSeries::SetMarksLocation(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CErrorBarSeries::GetBarRound()
{
	long result;
...
void CErrorBarSeries::SetBarRound(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeEmboss CErrorBarSeries::GetEmboss()
{
	LPDISPATCH pDispatch;
...
BOOL CErrorBarSeries::GetGradientRelative()
{
	BOOL result;
...
void CErrorBarSeries::SetGradientRelative(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CTeeRect CErrorBarSeries::CalcBarBounds(long ValueIndex)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_I4;
...
long CErrorBarSeries::GetErrorStyle()
{
	long result;
...
void CErrorBarSeries::SetErrorStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CErrorBarSeries::AddErrorBar(double AX, double AY, double AError, LPCTSTR AXLabel, unsigned long AColor)
{
	long result;
	static BYTE parms[] =
		VTS_R8 VTS_R8 VTS_R8 VTS_BSTR VTS_I4;
	InvokeHelper(0x192, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		AX, AY, AError, AXLabel, AColor);
	return result;
}
