...
CPen1 CErrorSeries::GetTickLines()
{
	LPDISPATCH pDispatch;
...
long CErrorSeries::GetDepthPercent()
{
	long result;
...
void CErrorSeries::SetDepthPercent(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeShadow CErrorSeries::GetShadow()
{
	LPDISPATCH pDispatch;
...
long CErrorSeries::GetTransparency()
{
	long result;
...
void CErrorSeries::SetTransparency(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CErrorSeries::GetBevelSize()
{
	long result;
...
void CErrorSeries::SetBevelSize(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CErrorSeries::SetDarkPen(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CErrorSeries::GetRoundSize()
{
	long result;
...
void CErrorSeries::SetRoundSize(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CErrorSeries::GetMarksOnBar()
{
	BOOL result;
...
void CErrorSeries::SetMarksOnBar(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CErrorSeries::GetMarksLocation()
{
	long result;
...
void CErrorSeries::SetMarksLocation(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CErrorSeries::SetBarRound(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeEmboss CErrorSeries::GetEmboss()
{
	LPDISPATCH pDispatch;
...
BOOL CErrorSeries::GetGradientRelative()
{
	BOOL result;
...
void CErrorSeries::SetGradientRelative(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CTeeRect CErrorSeries::CalcBarBounds(long ValueIndex)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_I4;
...
long CErrorSeries::AddErrorBar(double AX, double AY, double AError, LPCTSTR AXLabel, unsigned long AColor)
{
	long result;
	static BYTE parms[] =
