...
long CHorizBarSeries::GetRoundSize()
{
	long result;
...
void CHorizBarSeries::SetRoundSize(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CHorizBarSeries::GetMarksOnBar()
{
	BOOL result;
...
void CHorizBarSeries::SetMarksOnBar(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CHorizBarSeries::GetMarksLocation()
{
	long result;
...
void CHorizBarSeries::SetMarksLocation(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CHorizBarSeries::GetBarRound()
{
	long result;
...
void CHorizBarSeries::SetBarRound(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeEmboss CHorizBarSeries::GetEmboss()
{
	LPDISPATCH pDispatch;
...
BOOL CHorizBarSeries::GetGradientRelative()
{
	BOOL result;
...
void CHorizBarSeries::SetGradientRelative(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
