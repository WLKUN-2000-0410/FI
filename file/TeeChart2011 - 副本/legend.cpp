...
void CLegend::ShowEditorShape(BOOL HideTexts, LPCTSTR Caption)
{
	static BYTE parms[] =
		VTS_BOOL VTS_BSTR;
...
void CLegend::SetWidth(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CLegend::SetHeight(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CShapeCallout CLegend::GetShapeCallout()
{
	LPDISPATCH pDispatch;
...
CTeeCorners CLegend::GetCorners()
{
	LPDISPATCH pDispatch;
...
CTeeShapes CLegend::GetChildren()
{
	LPDISPATCH pDispatch;
...
void CLegend::SetChildLayout(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CLegend::SetAngle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CLegend::SetShapeVisible(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CLegend::SetTextFormat(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CLegend::SetTextSymbolGap(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CLegend::GetGlobalTransparency()
{
	long result;
...
void CLegend::SetGlobalTransparency(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CLegend::SetDrawBehind(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CTeeSelected CLegend::GetSelected()
{
	LPDISPATCH pDispatch;
