...
CSubChartChart CLegendPaletteTool::GetChart()
{
	LPDISPATCH pDispatch;
...
CTeeEmboss CLegendPaletteTool::GetEmboss()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x13d, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CTeeEmboss(pDispatch);
}

CTitles CLegendPaletteTool::GetFoot()
{
	LPDISPATCH pDispatch;
...
CTitles CLegendPaletteTool::GetSubFoot()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x13f, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CTitles(pDispatch);
}

CTitles CLegendPaletteTool::GetSubTitle()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x140, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CTitles(pDispatch);
}

CTitles CLegendPaletteTool::GetTitle()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x141, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CTitles(pDispatch);
}

CLegendPointer CLegendPaletteTool::GetPointer()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x142, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CLegendPointer(pDispatch);
}
