#if !defined(AFX_MAPPOLYGON_H__A8E1BA37_61C4_4F5A_B1AD_CE362F30AEF9__INCLUDED_)
#define AFX_MAPPOLYGON_H__A8E1BA37_61C4_4F5A_B1AD_CE362F30AEF9__INCLUDED_
...
public:
	...
	CPolygonSeries GetPoints();
	CString GetCode();
	void SetCode(LPCTSTR lpszNewValue);
	double GetSize();
	void SetSize(double newValue);
	CBackImage GetPicture();
	CTeePoint2D Centroid();
};

//{{AFX_INSERT_LOCATION}}
// Microsoft Visual C++ will insert additional declarations immediately before the previous line.

#endif // !defined(AFX_MAPPOLYGON_H__A8E1BA37_61C4_4F5A_B1AD_CE362F30AEF9__INCLUDED_)
