...
void CMapSeries::AddArrayXYZColor(const VARIANT& XArray, const VARIANT& YArray, const VARIANT& ZArray, const VARIANT& Colors)
{
	static BYTE parms[] =
...
long CMapSeries::GetLegendEvery()
{
	long result;
...
void CMapSeries::SetLegendEvery(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CMapSeries::CountLegendItems()
{
	long result;
...
void CMapSeries::LoadPaletteFromFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CMapSeries::SavePaletteToFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CMapSeries::SetPointSize(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeShadow CMapSeries::GetShadow()
{
	LPDISPATCH pDispatch;
...
BOOL CMapSeries::GetTransparent()
{
	BOOL result;
...
void CMapSeries::SetTransparent(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CMapSeries::GetTransparency()
{
	long result;
...
void CMapSeries::SetTransparency(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeEmboss CMapSeries::GetEmboss()
{
	LPDISPATCH pDispatch;
...
CMapMarks CMapSeries::GetMapMarks()
{
	LPDISPATCH pDispatch;
...
CPointer CMapSeries::GetPointer()
{
	LPDISPATCH pDispatch;
...
void CMapSeries::SetRenderMode(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
