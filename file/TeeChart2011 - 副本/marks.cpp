...
void CMarks::ShowEditorShape(BOOL HideTexts, LPCTSTR Caption)
{
	static BYTE parms[] =
		VTS_BOOL VTS_BSTR;
...
void CMarks::SetWidth(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CMarks::SetHeight(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CShapeCallout CMarks::GetShapeCallout()
{
	LPDISPATCH pDispatch;
...
void CMarks::SetChildLayout(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CMarks::SetShapeVisible(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CMarks::SetTextFormat(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CMarks::SetTextAlign(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CMarks::GetFontSeriesColor()
{
	BOOL result;
...
void CMarks::SetFontSeriesColor(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CMarks::SetOnTop(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CMarks::SetAutoPosition(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CMarks::SetSoftClip(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CMarks::GetUseSeriesTransparency()
{
	BOOL result;
...
void CMarks::SetUseSeriesTransparency(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
