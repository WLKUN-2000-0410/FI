...
double CPieSeries::GetCustomXRadius()
{
	double result;
...
void CPieSeries::SetCustomXRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CPieSeries::GetCustomYRadius()
{
	double result;
...
void CPieSeries::SetCustomYRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
CBrush1 CPieSeries::GetCircleBrush()
{
	LPDISPATCH pDispatch;
...
void CPieSeries::SetEdgeStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CPieSeries::GetBevelPercent()
{
	long result;
...
void CPieSeries::SetBevelPercent(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CPieSeries::GetTransparency()
{
	long result;
...
void CPieSeries::SetTransparency(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CPieAngle CPieSeries::GetAngles(long Index)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_I4;
