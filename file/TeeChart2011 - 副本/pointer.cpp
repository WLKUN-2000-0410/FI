...
void CPointer::SetFullGradient(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CPointer::SetDepth(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeePicture CPointer::GetPicture()
{
	LPDISPATCH pDispatch;
...
void CPointer::SetSizeFloat(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
void CPointer::SetSizeUnits(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
