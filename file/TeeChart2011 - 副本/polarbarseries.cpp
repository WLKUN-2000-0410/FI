...
double CPolarBarSeries::GetCustomXRadius()
{
	double result;
...
void CPolarBarSeries::SetCustomXRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CPolarBarSeries::GetCustomYRadius()
{
	double result;
...
void CPolarBarSeries::SetCustomYRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
CTeeShadow CPolarBarSeries::GetShadow()
{
	LPDISPATCH pDispatch;
...
CBrush1 CPolarBarSeries::GetCircleBrush()
{
	LPDISPATCH pDispatch;
...
BOOL CPolarBarSeries::GetColorEachLine()
{
	BOOL result;
...
void CPolarBarSeries::SetColorEachLine(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CPolarBarSeries::GetPointerBehind()
{
	BOOL result;
...
void CPolarBarSeries::SetPointerBehind(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CPolarBarSeries::GetDrawStyle()
{
	long result;
...
void CPolarBarSeries::SetDrawStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CPolarLabels CPolarBarSeries::GetAngleLabels()
{
	LPDISPATCH pDispatch;
