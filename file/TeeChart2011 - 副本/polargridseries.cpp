...
double CPolarGridSeries::GetCustomXRadius()
{
	double result;
...
void CPolarGridSeries::SetCustomXRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CPolarGridSeries::GetCustomYRadius()
{
	double result;
...
void CPolarGridSeries::SetCustomYRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
CTeeShadow CPolarGridSeries::GetShadow()
{
	LPDISPATCH pDispatch;
...
CBrush1 CPolarGridSeries::GetCircleBrush()
{
	LPDISPATCH pDispatch;
...
BOOL CPolarGridSeries::GetColorEachLine()
{
	BOOL result;
...
void CPolarGridSeries::SetColorEachLine(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CPolarGridSeries::GetPointerBehind()
{
	BOOL result;
...
void CPolarGridSeries::SetPointerBehind(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CPolarGridSeries::GetDrawStyle()
{
	long result;
...
void CPolarGridSeries::SetDrawStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CPolarGridSeries::GetTreatNulls()
{
	long result;
...
void CPolarGridSeries::SetTreatNulls(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CPolarGridSeries::GetLabelsMargin()
{
	long result;
...
void CPolarGridSeries::SetLabelsMargin(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CPolarLabels CPolarGridSeries::GetAngleLabels()
{
	LPDISPATCH pDispatch;
