...
double CPolarSeries::GetCustomXRadius()
{
	double result;
...
void CPolarSeries::SetCustomXRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CPolarSeries::GetCustomYRadius()
{
	double result;
...
void CPolarSeries::SetCustomYRadius(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
CTeeShadow CPolarSeries::GetShadow()
{
	LPDISPATCH pDispatch;
...
CBrush1 CPolarSeries::GetCircleBrush()
{
	LPDISPATCH pDispatch;
...
BOOL CPolarSeries::GetColorEachLine()
{
	BOOL result;
...
void CPolarSeries::SetColorEachLine(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CPolarSeries::GetPointerBehind()
{
	BOOL result;
...
void CPolarSeries::SetPointerBehind(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
long CPolarSeries::GetDrawStyle()
{
	long result;
...
void CPolarSeries::SetDrawStyle(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CPolarLabels CPolarSeries::GetAngleLabels()
{
	LPDISPATCH pDispatch;
