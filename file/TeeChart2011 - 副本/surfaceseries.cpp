...
void CSurfaceSeries::AddArrayGrid(long NumX, long NumZ, const VARIANT& XZArray)
{
	static BYTE parms[] =
...
long CSurfaceSeries::CalcZPos(long ValueIndex)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
void CSurfaceSeries::AddArrayXYZColor(const VARIANT& XArray, const VARIANT& YArray, const VARIANT& ZArray, const VARIANT& Colors)
{
	static BYTE parms[] =
...
BOOL CSurfaceSeries::GetUsePaletteMin()
{
	BOOL result;
...
void CSurfaceSeries::SetUsePaletteMin(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
double CSurfaceSeries::GetPaletteMin()
{
	double result;
...
void CSurfaceSeries::SetPaletteMin(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
double CSurfaceSeries::GetPaletteStep()
{
	double result;
...
void CSurfaceSeries::SetPaletteStep(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
void CSurfaceSeries::InvertPalette()
{
	InvokeHelper(0x130, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void CSurfaceSeries::AddCustomPalette(const VARIANT& colorArray)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
long CSurfaceSeries::GetLegendEvery()
{
	long result;
...
void CSurfaceSeries::SetLegendEvery(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CSurfaceSeries::CountLegendItems()
{
	long result;
...
void CSurfaceSeries::LoadPaletteFromFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CSurfaceSeries::SavePaletteToFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CSurfaceSeries::SmoothGrid3D()
{
	InvokeHelper(0x191, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

BOOL CSurfaceSeries::GetReuseGridIndex()
{
	BOOL result;
...
void CSurfaceSeries::SetReuseGridIndex(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void CSurfaceSeries::FillGridIndex(long StartIndex)
{
	static BYTE parms[] =
		VTS_I4;
...
void CSurfaceSeries::ReCreateValues()
{
...
long CSurfaceSeries::GetTransparency()
{
	long result;
...
void CSurfaceSeries::SetTransparency(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
BOOL CSurfaceSeries::GetFastBrush()
{
	BOOL result;
...
void CSurfaceSeries::SetFastBrush(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
BOOL CSurfaceSeries::GetHideCells()
{
	BOOL result;
...
void CSurfaceSeries::SetHideCells(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
...
CChartHiddenPen CSurfaceSeries::GetSideLines()
{
	LPDISPATCH pDispatch;
