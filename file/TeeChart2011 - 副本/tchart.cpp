...
BOOL CTChart::EditStrings(BSTR* Strings, BOOL ReadOnly)
{
	BOOL result;
	static BYTE parms[] =
		VTS_PBSTR VTS_BOOL;
...
void CTChart::SetLanguage(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CTChart::SetLanguaged(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CTChart::MultiLineTextWidth(LPCTSTR AString, long NumLines, long TextFormat)
{
	long result;
	static BYTE parms[] =
...
long CTChart::MultiLineTextHeight(LPCTSTR AString, long NumLines, long TextFormat)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_I4 VTS_I4;
...
CAnimationList CTChart::GetAnimations()
{
	LPDISPATCH pDispatch;
...
CSeries CTChart::CreateNewSeriesGallery(long AGalleryWidth, long AGalleryHeight)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
		VTS_I4 VTS_I4;
...
CTeePanning CTChart::GetPanning()
{
	LPDISPATCH pDispatch;
...
long CTChart::ActiveSeriesLegend(long ItemIndex)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
void CTChart::ShowSeriesEditor(long SeriesIndex)
{
	static BYTE parms[] =
		VTS_I4;
...
long CTChart::CloneSeriesFromChart(long ChartLink, long SeriesIndex)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_I4;
...
long CTChart::CloneToolFromChart(long ChartLink, long ToolIndex)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_I4;
...
CSeries CTChart::CreateSeriesChangeGallery(long AGalleryWidth, long AGalleryHeight, long SeriesIndex)
{
	LPDISPATCH pDispatch;
	static BYTE parms[] =
...
void CTChart::SetZoomWheel(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CTChart::SetChartRect(long Left, long Top, long Right, long Bottom)
{
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4 VTS_I4;
...
CTeeAnimate CTChart::GetAnimate()
{
	LPDISPATCH pDispatch;
...
VARIANT CTChart::GetChartLinkx64()
{
	VARIANT result;
...
long CTChart::CloneSeriesFromChartx64(const VARIANT& ChartLinkx64, long SeriesIndex)
{
	long result;
	static BYTE parms[] =
		VTS_VARIANT VTS_I4;
...
long CTChart::CloneToolFromChartx64(const VARIANT& ChartLinkx64, long ToolIndex)
{
	long result;
	static BYTE parms[] =
		VTS_VARIANT VTS_I4;
