...
CSkewnessFunction CTeeFunction::GetAsSkewness()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xda, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CSkewnessFunction(pDispatch);
}

CRVIFunction CTeeFunction::GetAsRVI()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xdb, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CRVIFunction(pDispatch);
}

CAlligatorFunction CTeeFunction::GetAsAlligator()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xdc, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CAlligatorFunction(pDispatch);
}

CMoneyFlowFunction CTeeFunction::GetAsMoneyFlow()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xdd, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CMoneyFlowFunction(pDispatch);
}

long CTeeFunction::GetClassType()
{
	long result;
