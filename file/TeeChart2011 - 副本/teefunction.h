#if !defined(AFX_TEEFUNCTION_H__642C3E2B_5013_4E75_88DA_B87B6D234829__INCLUDED_)
#define AFX_TEEFUNCTION_H__642C3E2B_5013_4E75_88DA_B87B6D234829__INCLUDED_
...
class CSkewnessFunction;
class CRVIFunction;
class CAlligatorFunction;
class CMoneyFlowFunction;
class CATRFunction;
class CParetoFunction;
...
public:
	...
	CSkewnessFunction GetAsSkewness();
	CRVIFunction GetAsRVI();
	CAlligatorFunction GetAsAlligator();
	CMoneyFlowFunction GetAsMoneyFlow();
	long GetClassType();
	CATRFunction GetAsATR();
	CParetoFunction GetAsPareto();
};

//{{AFX_INSERT_LOCATION}}
// Microsoft Visual C++ will insert additional declarations immediately before the previous line.

#endif // !defined(AFX_TEEFUNCTION_H__642C3E2B_5013_4E75_88DA_B87B6D234829__INCLUDED_)
