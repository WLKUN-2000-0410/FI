...
CFullScreenTool CTools::GetAsFullScreen()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xe9, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CFullScreenTool(pDispatch);
}

CAxisBreaksTool CTools::GetAsAxisBreaks()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xea, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CAxisBreaksTool(pDispatch);
}

CSubChartTool CTools::GetAsSubChart()
{
	LPDISPATCH pDispatch;
...
CClusteringTool CTools::GetAsClustering()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xec, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CClusteringTool(pDispatch);
}

CRepaintMonitorTool CTools::GetAsRepaintMonitor()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xed, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CRepaintMonitorTool(pDispatch);
}

CArrowTool CTools::GetAsArrow()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xee, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CArrowTool(pDispatch);
}

CScrollPagerTool CTools::GetAsScrollPager()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xef, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CScrollPagerTool(pDispatch);
}

CAxisScrollBarTool CTools::GetAsAxisScrollBar()
{
	LPDISPATCH pDispatch;
	InvokeHelper(0xf0, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CAxisScrollBarTool(pDispatch);
}
...
void CTools::SetTag(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
