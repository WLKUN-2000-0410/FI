#if !defined(AFX_TOOLS_H__DC57D956_4568_416B_A101_517DFF8D44CB__INCLUDED_)
#define AFX_TOOLS_H__DC57D956_4568_416B_A101_517DFF8D44CB__INCLUDED_
...
class CSubChartTool;
class CClusteringTool;
class CRepaintMonitorTool;
class CArrowTool;
class CScrollPagerTool;
class CAxisScrollBarTool;
...
public:
	...
	CClusteringTool GetAsClustering();
	CRepaintMonitorTool GetAsRepaintMonitor();
	CArrowTool GetAsArrow();
	CScrollPagerTool GetAsScrollPager();
	CAxisScrollBarTool GetAsAxisScrollBar();
	long GetTag();
	void SetTag(long nNewValue);
};

//{{AFX_INSERT_LOCATION}}
// Microsoft Visual C++ will insert additional declarations immediately before the previous line.

#endif // !defined(AFX_TOOLS_H__DC57D956_4568_416B_A101_517DFF8D44CB__INCLUDED_)
