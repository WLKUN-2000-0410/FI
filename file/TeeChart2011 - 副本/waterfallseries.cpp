...
void CWaterfallSeries::AddArrayXYZColor(const VARIANT& XArray, const VARIANT& YArray, const VARIANT& ZArray, const VARIANT& Colors)
{
	static BYTE parms[] =
...
long CWaterfallSeries::GetLegendEvery()
{
	long result;
...
void CWaterfallSeries::SetLegendEvery(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
long CWaterfallSeries::CountLegendItems()
{
	long result;
...
void CWaterfallSeries::LoadPaletteFromFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CWaterfallSeries::SavePaletteToFile(LPCTSTR FileName)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CWaterfallSeries::ReCreateValues()
{
