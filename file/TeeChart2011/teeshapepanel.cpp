...
long CTeeShapePanel::GetTextFormat()
{
	long result;
...
void CTeeShapePanel::SetTextFormat(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
CTeeEmboss CTeeShapePanel::GetEmboss()
{
	LPDISPATCH pDispatch;
...
void CTeeShapePanel::SetWidth(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
...
void CTeeShapePanel::SetHeight(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
